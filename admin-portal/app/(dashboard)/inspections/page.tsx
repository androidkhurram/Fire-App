...
export default async function InspectionsPage({
  ...
  const inspections = filterInspections(allInspections, params);

  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Inspections</h1>
                  ...
                  <tr key={i.id as string} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${
                        i.inspection_status === 'pass' ? 'bg-green-100 text-green-800' :
                        i.inspection_status === 'fail' ? 'bg-red-100 text-red-800' :
