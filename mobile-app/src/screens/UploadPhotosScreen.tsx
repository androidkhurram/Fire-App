...
export function UploadPhotosScreen({
  ...
  onBack,
  onComplete,
}: UploadPhotosScreenProps) {
  const [photos, setPhotos] = useState<Array<{uri: string; uploading?: boolean}>>([]);
  ...
  const pickImage = async (fromCamera: boolean) => {
    ...
    try {
      ...
      if (inspectionId) {
        setUploading(true);
        try {
          const url = await dataService.uploadInspectionPhoto(inspectionId, {
            uri: assetUri,
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Take photos or upload from gallery to document the inspection
      </Text>
